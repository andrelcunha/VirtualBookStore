 ...
 * @author luiscunha
 */
@WebServlet(name = "UsuarioNgn", urlPatterns = {"/UsuarioNgn"})
public class UsuarioNgn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (con.connect()){
                usr_dao.setConnection(con.getCon());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(UsuarioNgn.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
