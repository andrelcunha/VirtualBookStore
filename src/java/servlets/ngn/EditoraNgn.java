 ...
 * @author luiscunha
 */
@WebServlet(name = "EditoraNgn", urlPatterns = {"/EditoraNgn"})
public class EditoraNgn extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            if (con.connect()){
                ed_dao.setConnection(con.getCon());
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(EditoraNgn.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
